...
void init_ds1302()
{
	...
	Write_Ds1302_Byte(0x80,(0/10)*16+(0%10));
	Write_Ds1302_Byte(0x82,(0/10)*16+(0%10));
	Write_Ds1302_Byte(0x84,(0/10)*16+(0%10));
...
void main() 
{
  ...
  while(1)  
  {
		read_ds1302();
		clean_SEG();
		display_SEG(7,time[0]%10,1);
		delay_ms(2);
		display_SEG(6,time[0]/10%10,1);
		delay_ms(2);
		display_SEG(5,16,1);
		delay_ms(2);
		display_SEG(4,time[1]%10,1);
		delay_ms(2);
		display_SEG(3,time[1]/10%10,1);
		delay_ms(2);
		display_SEG(2,16,1);
		delay_ms(2);
		display_SEG(1,time[2]%10,1);
		delay_ms(2);
		display_SEG(0,time[2]/10%10,1);
		delay_ms(2);
  }
}